...
CREATE TABLE csc343countrylanguage (
    countrycode character(3) NOT NULL,
...
COPY csc343city (id, name, countrycode, district, population) FROM stdin;
...
COPY csc343country (code, name, continent, region, surfacearea, indepyear, population, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital, code2) FROM stdin;
...
COPY csc343countrylanguage (countrycode, countrylanguage, isofficial, percentage) FROM stdin;
...
ALTER TABLE ONLY csc343city
    ADD CONSTRAINT city_pkey PRIMARY KEY (id);

ALTER TABLE ONLY csc343country
    ADD CONSTRAINT country_pkey PRIMARY KEY (code);

ALTER TABLE ONLY csc343countrylanguage
    ADD CONSTRAINT countrylanguage_pkey PRIMARY KEY (countrycode, countrylanguage);

ALTER TABLE ONLY csc343country
    ADD CONSTRAINT country_capital_fkey FOREIGN KEY (capital) REFERENCES csc343city(id);

ALTER TABLE ONLY csc343countrylanguage
    ADD CONSTRAINT countrylanguage_countrycode_fkey FOREIGN KEY (countrycode) REFERENCES csc343country(code);

ALTER TABLE ONLY csc343city
    ADD CONSTRAINT country_countrycode_fkey FOREIGN KEY (countrycode) REFERENCES csc343country(code);
